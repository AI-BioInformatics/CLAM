...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str,default="/mnt/beegfs/work/H2020DeciderFicarra/gbontempo/patches/clampatches/tumor")
    parser.add_argument('--source_dir', type=str, default="/mnt/beegfs/work/H2020DeciderFicarra/gbontempo/datasets/camelyon16/training/tumor")
