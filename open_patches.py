...
def process(bag_candidate_idx,args):
    ...
    slide_id = bags_dataset[bag_candidate_idx].split(args.slide_ext)[0].split(os.sep)[-1]
...
if __name__ == '__main__':
    ...
    executor.update_parameters(slurm_partition="prod",name="data_prep",slurm_time=60,mem_gb=15,slurm_array_parallelism=10)
